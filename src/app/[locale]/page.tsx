      ...
      <section className="grid gap-6 border-2 border-[var(--ink)] bg-[var(--paper)] p-6 md:grid-cols-[1.2fr_0.8fr]">
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a href="#popular-tcgs" className="border border-[var(--ink)] px-4 py-2 text-sm font-semibold hover:bg-[var(--ink)] hover:text-[var(--paper)]">
              {messages.hero.ctaPrimary}
            </a>
            <a href="#trending-cards" className="border border-[var(--ink)] px-4 py-2 text-sm font-semibold hover:bg-[var(--ink)] hover:text-[var(--paper)]">
